 ...
 */
public class BilibiliFlvUrlParser implements PlatformVideoUrlParser<BilibiliLiveOnlineConfig> {
    ...
    @Override
    public String getUrl(BilibiliLiveOnlineConfig loadRecordConfig) throws Exception {
